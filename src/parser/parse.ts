...
type Context = {
  ...
  parent: AlternativeNode | CharacterClassNode;
...
type UnnamedCharacterSetNode = Omit<CharacterSetNode, 'value'> & {
...
function createUnicodeProperty(name: string, options?: CreateUnicodePropertyOptions): CharacterSetNode & {
  kind: 'property';
  value: string;
  negate: boolean;
} {
